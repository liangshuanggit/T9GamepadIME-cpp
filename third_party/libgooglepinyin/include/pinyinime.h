...
extern "C" {
  ...
  /**
   * Validate a spelling string.
   *
   * @param sps_buf The spelling string to validate.
   * @param sps_len The length of the spelling string.
   * @return 0 if invalid, 1 if a valid prefix, 2 if a complete valid pinyin.
   */
